	...
	return (
		<div className="welcome" data-screen-label="Auth">
			<main id="main-content" className="welcome-card fade-in">
				...
				{callbackError === "denied" && <p className="auth-error">Google sign-in was cancelled.</p>}
				{(callbackError === "oauth_error" ||
					(callbackError !== null && !["expired", "denied"].includes(callbackError))) && (
					<p className="auth-error">Sign-in failed — please try again.</p>
				)}
